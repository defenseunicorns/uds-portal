...
<div class="flex flex-col">
  <div class="bg-gray-200 rounded-full dark:bg-gray-700 group-hover:dark:bg-gray-600 mt-3">
    <div
  ...
  <div class="text-xs text-left mt-1 font-normal text-gray-500 dark:text-gray-100 truncate overflow-ellipsis">
    <span>
      {progressText}
    </span>
  </div>
