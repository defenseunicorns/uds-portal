...
<div class="fixed right-5 p-4 z-40">
  {#each $toast as toast}
    <div
      class="flex items-center justify-between shadow-gray-900 w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow-lg dark:text-gray-100 dark:bg-gray-800 mb-4"
    ...
    >
      ...
      {#if !toast.noClose}
        <button
          type="button"
          class="flex-shrink-0 bg-white text-gray-100 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700"
