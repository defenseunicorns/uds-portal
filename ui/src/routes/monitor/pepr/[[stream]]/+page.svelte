  ...
  <div class="table-container">
    <div class="table-content">
      <div class="table-header">
        <span class="dark:text-gray-100" data-testid="table-header">{'Pepr Events'}</span>
        {#if isFiltering}
      ...
      <div class="table-filter-section">
        <div class="relative lg:w-96">
          ...
          <input
            ...
            name="input-search"
            autocomplete="off"
            class="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-9 text-gray-900 sm:text-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-300"
            placeholder="Search"
        ...
        >
          <button name="Export" type="button" class="rounded-lg" on:click={() => exportPeprStream($rows)}>
            <Export class="mr-2" />
            Export
          </button>
        </div>
